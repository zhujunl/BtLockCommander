...
public class CRC16 {
	...
	public char caluCRC(byte[] pByte, int length) {
		char crc;
		byte da;
		crc = 0x00; // ��Ϊ0x0ʱ�����ӦCRC-CCITT (XModem)����Ϊ0xFFFFʱ�����ӦCRC-CCITT
					// (0xFFFF)����Ϊ0x1D0Fʱ���ΪCRC-CCITT (0x1D0F)��
		int i = 0;
		while (length-- != 0) {
			da = (byte) (crc / 256);
			crc <<= 8;
	...
	public static void main(String[] args) {
		...
		byte[] test = "123456789".getBytes();// {(byte)0x01, (byte)0xd0,
												// (byte)0x04, (byte)0x7d};
		char ch = crc.caluCRC(test, 5);

		// ������Ϊ�˲��Է�����еĴ�����Ϊchar�������ͺܶ��ǲ�����ʾ��
		int i = (int) ch;
		String str = Integer.toHexString(i);
		System.out.println("CRCʮ�������ַ�����: " + str);
